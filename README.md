...
| 10 | 💵 [Company Valuation - DCF Analysis](https://github.com/namanh-ph/company-valuation-dcf-analysis) | Finance, valuation modelling | Excel, Python, yfinance | Two complementary DCF approaches: a deep-dive Excel valuation of a listed Australian comapny (financial-statement forecasting, DuPont decomposition, bottom-up beta, CAPM-based WACC, sensitivity analysis) and a Python pipeline that stress-tests and reverse-engineers what the company market price implies. |
